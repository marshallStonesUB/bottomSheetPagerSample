...
/**
 * https://qiita.com/kafumi/items/9ca1dfefe2289d55c499から持ってきた
 *
 * BottomSheetにViewpagerを配置するとスクロールがおかしくなる問題を
 * ViewPagerの場合は、深さ優先探索ではなく、
 * ViewPagerが表示しているページがスクロール可能な子Viewとして認識されるようにする
 * ことにより解決しています
 */
